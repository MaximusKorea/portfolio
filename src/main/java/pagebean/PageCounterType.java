...
// 페이징 처리 계산
public class PageCounterType{	
	public static ListResultBeanType getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount,
												String board_type) throws Exception{
		ListResultBeanType resultBean = new ListResultBeanType();
	...
	public static void main(String[] args) throws Exception {
		...
		ListResultBeanType resultBean = PageCounterType.getPagingInfo(selectPage, rowCountPerPage, pageCountPerPage, totalRecordCount, board_type);
		System.out.println("***************페이지정보***************");
