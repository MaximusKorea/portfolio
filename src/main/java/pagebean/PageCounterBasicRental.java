...
// 페이징 처리 계산
public class PageCounterBasicRental{	
	public static ListResultBeanBasicRental getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount) throws Exception{
		ListResultBeanBasicRental resultBean = new ListResultBeanBasicRental();
