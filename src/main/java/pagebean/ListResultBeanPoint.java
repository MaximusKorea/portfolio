...
public class ListResultBeanPoint {
	private List<Point> list; 		// 리스트 데이터 콜렉션
	...
	public ListResultBeanPoint() {}
	public ListResultBeanPoint(List<Point> list, int startPageNo, int endPageNo,
