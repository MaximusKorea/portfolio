...
// 페이징 처리 계산
public class PageCounterContent{	
	public static ListResultBeanContent getPagingInfo(	int selectPage,
												int rowCountPerPage,
		...
		ListResultBeanContent resultBean = new ListResultBeanContent();
		...
		resultBean.setBoard_content(board_content);
		...
		System.out.println("15.board_content:\t\t\t"+resultBean.getBoard_content()); 		
		System.out.println("16.board_type:\t\t\t"+resultBean.getBoard_type()); 		
		System.out.println("17.board_writer:\t\t\t"+resultBean.getBoard_writer()); 		
		System.out.println("**************************************");
		return resultBean;				
	}
