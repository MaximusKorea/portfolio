...
public class ListResultBeanBasicRental {
	private List<MovieRental> listRental; // 리스트 데이터 콜렉션
	...
	public ListResultBeanBasicRental() {}
	public ListResultBeanBasicRental(List<MovieRental> listRental, int startPageNo, int endPageNo,
	...
	public List<MovieRental> getListRental() {
		return listRental;
	}

	public void setListRental(List<MovieRental> listRental) {
		this.listRental = listRental;
	}
