...
// 페이징 처리 계산
public class PageCounterReserve{	
	public static ListResultBeanReserve getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount,
												int m_no) throws Exception{
		ListResultBeanReserve resultBean = new ListResultBeanReserve();
	...
	public static void main(String[] args) throws Exception {
		...
		int m_no = 23;
		ListResultBeanReserve resultBean = PageCounterReserve.getPagingInfo(selectPage, rowCountPerPage, pageCountPerPage, totalRecordCount, m_no);
		System.out.println("***************페이지정보***************");
		System.out.println("01.selectPage:\t\t\t" + resultBean.getSelectPageNo());
		System.out.println("02.rowCountPerPage:\t\t" + rowCountPerPage);
		System.out.println("03.pageCountPerPage:\t\t" + pageCountPerPage);
