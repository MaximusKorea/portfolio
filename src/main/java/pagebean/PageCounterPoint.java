...
// 페이징 처리 계산
public class PageCounterPoint{	
	public static ListResultBeanPoint getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount,
												int m_no) throws Exception{
		ListResultBeanPoint resultBean = new ListResultBeanPoint();
		...
		System.out.println("15.pointList:\t\t\t"+resultBean.getList()); 		
		System.out.println("**************************************");
		return resultBean;				
	}
	...
	public static void main(String[] args) throws Exception {
		...
		int m_no = 23;
		ListResultBeanPoint resultBean = PageCounterPoint.getPagingInfo(selectPage, rowCountPerPage, pageCountPerPage, totalRecordCount, m_no);
		System.out.println("***************페이지정보***************");
		System.out.println("01.selectPage:\t\t\t" + resultBean.getSelectPageNo());
		System.out.println("02.rowCountPerPage:\t\t" + rowCountPerPage);
		System.out.println("03.pageCountPerPage:\t\t" + pageCountPerPage);
