...
public class ListResultBeanTypeWriter {
	...
	public ListResultBeanTypeWriter() {}
	public ListResultBeanTypeWriter(List<Board> list, int startPageNo, int endPageNo,
			...
			int startRowNum, int endRowNum, String board_type, String board_writer) {
		this.list = list;
