...
// 페이징 처리 계산
public class PageCounterTypeWriter{	
	public static ListResultBeanTypeWriter getPagingInfo(	int selectPage,
															int rowCountPerPage,
															int pageCountPerPage, 
															int totalRecordCount,
															String board_type,
															String board_writer) throws Exception{
		ListResultBeanTypeWriter resultBean = new ListResultBeanTypeWriter();
		...
		resultBean.setBoard_type(board_type);
		resultBean.setBoard_writer(board_writer);
		...
		System.out.println("01.selectPageNo:\t\t\t"+resultBean.getSelectPageNo());
	...
	public static void main(String[] args) throws Exception {
		...
		String board_type = "공지사항";
		String board_writer = "board_writer";
		ListResultBeanTypeWriter resultBean = PageCounterTypeWriter.getPagingInfo(selectPage, rowCountPerPage, pageCountPerPage, totalRecordCount, board_type, board_writer);
		System.out.println("***************페이지정보***************");
		...
		System.out.println("13.isShowFirst:\t\t\t" + resultBean.isShowFirst());
		System.out.println("14.isShowLast:\t\t\t" + resultBean.isShowLast());
		System.out.println("15.board_type:\t\t\t" + resultBean.getBoard_type());
		System.out.println("**************************************");
	}
