...
public class ListResultBeanType {
	...
	public ListResultBeanType() {}
	public ListResultBeanType(List<Board> list, int startPageNo, int endPageNo,
			...
			int startRowNum, int endRowNum, String board_type) {
		this.list = list;
