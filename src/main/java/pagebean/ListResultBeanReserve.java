...
public class ListResultBeanReserve {
	private List<MemberJoinResult> list; 		// 리스트 데이터 콜렉션
	...
	public ListResultBeanReserve() {}
	public ListResultBeanReserve(List<MemberJoinResult> list, int startPageNo, int endPageNo,
			...
			int startRowNum, int endRowNum, int m_no) {
		this.list = list;
	...
	public List<MemberJoinResult> getList() {
		return list;
	}

	public void setList(List<MemberJoinResult> list) {
		this.list = list;
	}
