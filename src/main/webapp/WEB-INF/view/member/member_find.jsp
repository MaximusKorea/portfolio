	...
	$(function(){
		$('#findId').validate({
			...
			submitHandler:function(f){
				...
				window.open("findId?m_name="+m_name+"&m_phone="+m_phone+"&m_birth="+m_birth,"아이디찾기","width=360 height=160 resizable=yes");
				f.submit();
			}
		});
	})
...
<div class="content">
	<div class="register">
		<div class="col-md-6 login-left">
			<h2><strong>아이디찾기</strong></h2>
			<p><strong>이름/전화번호/생년월일<strong></p>
