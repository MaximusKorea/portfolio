...
<script type="text/javascript">
	...
	function input() {
		if(document.movie_info.mv_name.value == ""){
			alert("영화명을 입력해주세요.");
		...
		if(document.movie_info.mv_runTime.value == ""){
			alert("상영시간을 입력해주세요.");
			movie_info.mv_name.focus();
			return false;
		}
	 	movie_info.action = "manage_movie_info_action";
							...
							<form name="movie_info" method="post" enctype="multipart/form-data">
								<table border="0" cellpadding="0" cellspacing="1" bgcolor="BBBBBB">					
									<tr>
										...
										<input type="text" name="mv_name"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">제작국가</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_state"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">감독</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_director"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">배우</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_actor"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">상영시간</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_runTime"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">영화정보</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<textarea name="mv_info" onkeyup="xSize(this)" style="width:300px; height:36px; overflow-y:hidden" ></textarea></td>
										</tr>
									<tr>
									...
									<tr>
										...
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_trailer"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">장르</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_genre"></input></td>
									</tr>
								</table>
							</form>
							<br/>
