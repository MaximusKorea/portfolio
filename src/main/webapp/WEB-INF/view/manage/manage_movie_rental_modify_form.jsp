...
<script type="text/javascript">
	...
	function input(){	
		if(document.movie_info.mv_rt_date.value == ""){
			alert("개봉 날짜를 입력해주세요.");
			movie_info.mv_rt_name.focus();
			return false;
		}
		movie_info.action = "manage_movie_rental_modify_action";
		movie_info.method="POST";
		movie_info.submit();
	}	
	function golist(){
		movie_info.action = "manage_movie_rental_list?pageno=1";
		movie_info.method="POST";
		movie_info.submit();
	}
	function reset() {
						...
						<td>
							...
							<form name="movie_info" method="post" enctype="multipart/form-data">
								<table border="0" cellpadding="0" cellspacing="1" bgcolor="BBBBBB">
									<input type="hidden" name="mv_rt_no" value="${movieRental.mv_rt_no}">			
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">영화명</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_rt_name" value="${movieRental.mv_rt_name}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">제작국가</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_rt_state" value="${movieRental.mv_rt_state}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">감독</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_rt_director" value="${movieRental.mv_rt_director}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">배우</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_rt_actor" value="${movieRental.mv_rt_actor}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">상영시간</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_rt_runTime" value="${movieRental.mv_rt_runTime}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">영화정보</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<textarea name="mv_rt_info" onkeyup="xSize(this)" style="width:300px; height:36px; overflow-y:hidden" >${movieRental.mv_rt_info}</textarea></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="file" name="file" value="${movieRental.mv_rt_image}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">트레일러(url)</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px"
										><input type="text" name="mv_rt_trailer" value="${movieRental.mv_rt_trailer}"></input></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">장르</td>
										<td width=490 align="left" bgcolor="ffffff" style="padding-left: 10px">
										<input type="text" name="mv_rt_genre" value="${movieRental.mv_rt_genre}"></input></td>
									</tr>
								</table>
							</form>
							<br/>
